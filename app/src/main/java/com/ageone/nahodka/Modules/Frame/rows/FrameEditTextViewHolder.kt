...
class FrameEditTextViewHolder(val constraintLayout: ConstraintLayout) :
...
fun FrameEditTextViewHolder.renderUI() {
...
fun FrameEditTextViewHolder.initialize(hint: String) {
