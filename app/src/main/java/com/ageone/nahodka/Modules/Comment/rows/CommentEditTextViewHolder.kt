package com.ageone.nahodka.Modules.Comment.rows
...
class CommentEditTextViewHolder(val constraintLayout: ConstraintLayout) :
...
fun CommentEditTextViewHolder.renderUI() {
